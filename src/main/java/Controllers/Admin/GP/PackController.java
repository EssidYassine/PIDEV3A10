...
public class PackController {
    ...
    public void initialize() {
        try {
            ...
            if (packGridPane == null) {
                System.err.println("Erreur : packGridPane est null. Vérifiez que le fichier FXML est bien chargé.");
                return;
            }
    ...
    private void handlBack(ActionEvent event) {
        navigateToScene(event, "/Views/Admin/GP/Home.fxml");
    }
